      ...
      return (
        ...
        <View style={styles.rowRight}>
          <View
            ...
            style={{width: viewWidth, height: viewHeight, backgroundColor: '#b6e858', borderRadius: 2,marginRight: 3}}
            >
            <Text
      ...
      return (
        ...
        <View style={styles.rowLeft}>
          <View
            ...
            style={{width: viewWidth+ 15,maxWidth:screenWidth-15, height: viewHeight, backgroundColor: 'white', borderRadius: 2,marginLeft: 3}}
            >
            <Text
        ...
        <Animated.View style = {{opacity: this.state.fadeAnim}}>
          <View style={styles.rowCenter}>
            <View
              ...
              style={{width: viewWidth, maxWidth:screenWidth-15,height: viewHeight, opacity: 1,backgroundColor:'red'}}
              >
            <Text
        ...
        <Animated.View style = {{opacity: this.state.fadeAnim}}>
          <View style={styles.rowCenter}>
            <View
              ...
              style={{ justifyContent: 'center',maxWidth:screenWidth-15, width: viewWidth + 15, height: viewHeight, opacity: 1,backgroundColor:'red', borderRadius: 5}}
              >
            <Text
              ref={v => this.CenterText = v}
